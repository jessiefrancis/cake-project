...
class UserFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'CreatedAt' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => 'current_timestamp()', 'comment' => '', 'precision' => null],
        'UpdatedAt' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => 'current_timestamp()', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'RoleId' => 1,
                'CreatedAt' => 1628516043,
                'UpdatedAt' => 1628516043,
            ],
        ];
        parent::init();
    }
